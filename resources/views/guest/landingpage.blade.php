...
<head>
    ...
    <meta name="description" content="{{ $landing->goal }}">
    <meta name="keywords" content="Formacion, Cursos, Politica, Diplomados, Talleres, Mexico, Municipio, Lideres, Emprendimiento">
...
<body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <header class=" absolute top-0 left-0 right-0 z-10">
        <div class="container mx-auto">
            <div class="flex items-center">
                <div class="flex-1">
                    {{-- <img src="{{ URL::asset('img/logo.svg')}}" class="h-40"> --}}
    ...
    <div class="pt-24">
        ...
        <div class="container mx-auto md:px-16  mx-auto flex flex-wrap flex-col md:flex-row items-center">
            <!--Left Col-->
            <div class="flex flex-col w-full md:w-3/5 justify-center items-start text-center md:text-left">
                <p class="uppercase tracking-loose w-full wow fadeInLeft">{{ $landing->date_start }}</p>
                <h1 class="my-4 text-5xl font-bold leading-tight wow fadeInLeft">{{ $landing->name }}</h1>
                <div class="block">
                    <div class="inline-flex">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="stroke-current"><polygon points="1 6 1 22 8 18 16 22 23 18 23 2 16 6 8 2 1 6"></polygon><line x1="8" y1="2" x2="8" y2="18"></line><line x1="16" y1="6" x2="16" y2="22"></line></svg>
                        <p class="font-bold text-secondary-600 uppercase ml-2 wow fadeInLeft">{{ $landing->place }} </p>
                    </div>
                </div>
                <div class="block">
                    <div class="inline-flex">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="stroke-current"><circle cx="12" cy="8" r="7"></circle><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"></polyline></svg>
                        <p class="font-bold text-secondary-600 uppercase ml-2 wow fadeInLeft"> {{ $landing->category->nombre }} </p>
                    </div>
                </div>
                <div class="block  mb-10">
                    <div class="inline-flex">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"  class="stroke-current"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>
                        <p class="font-bold text-secondary-600 uppercase ml-2 wow fadeInLeft">
                            @switch($landing->modality)
                            @case(1)
                                PRESENCIAL
                                @break
                            @case(2)
            ...
            <!--Right Col-->
            <div class="w-full md:w-2/5 md:py-2 text-center sm:mb-10">
                @if(strlen($landing->photo) > 2)
                    <img class="w-full md:w-4/5 z-50 wow fadeInRight" src="{{ URL::asset('img/'.$landing->photo)}}">
                @else
                    <img class="w-full md:w-4/5 z-50 wow fadeInRight" src="{{ URL::asset('img/noimagelanding.svg')}}">
                @endif
            </div>
    ...
    {{-- <div class="relative overflow-hidden px-6 pb-6">
        <div class="container mx-auto relative">
            <div class="flex flex-col md:flex-row items-center pt-28 pb-16 md:pb-0">
                <div class="md:w-1/2 lg:w-1/3 mb-4 sm:mb-16 md:mb-0">
                    <h2 class="text-xl font-bold text-secondary-600 uppercase mb-2 wow fadeInLeft">{{ $landing->date_start }}</h2>
                    <h1 class="text-4xl md:text-5xl font-bold text-secondary leading-tight  md:mb-10 wow fadeInLeft">{{ $landing->name }}</h1>
                    <div class="block">
                        <div class="inline-flex">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="stroke-current"><polygon points="1 6 1 22 8 18 16 22 23 18 23 2 16 6 8 2 1 6"></polygon><line x1="8" y1="2" x2="8" y2="18"></line><line x1="16" y1="6" x2="16" y2="22"></line></svg>
                            <p class="font-bold text-secondary-600 uppercase ml-2 wow fadeInLeft">{{ $landing->place }} </p>
                    ...
                    <div class="block  mb-10">
                     ...
                     <a href="#" class="bg-black px-6 md:px-8 py-3 md:py-4 text-lg md:text-xl text-secondary font-bold uppercase rounded hover:bg-primary-400">CONTACTAR VENDEDORA</a> 
                </div>
        ...
        <div class="container max-w-5xl mx-auto m-8">
            <div class="flex flex-wrap">
                <div class="w-5/6 sm:w-1/2 p-6">
                    <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3  wow fadeInUp">Objetivo</h3>
                    <p class="text-gray-600 mb-8  wow fadeInUp">
                        {{ $landing->goal }}
                    </p>
            ...
            <circle cx="600.35" cy="480.68" r="11.968" fill="#ff6347"/>
                ...
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <div class="align-middle">
                        <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3  wow fadeInUp">Dirigido a</h3>
                        <p class="text-gray-600 mb-8  wow fadeInUp">
    ...
    <!-- Section of details -->
    <section class="bg-white  py-8 bg-gray-300 ">
        <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">Detalles</h1>
        <div class="w-full mb-4">
            <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
        </div>
        <div class="container mx-auto px-4 pt-8">
            <div class="flex flex-wrap">
                <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center  wow fadeInUp">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                        <div class="px-4 py-5 flex-auto">
                            <div class="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-red-400">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="stroke-current"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path></svg>

                            </div>
                            <h6 class="text-xl text-gray-800 font-semibold">MODALIDAD</h6>
                            <p class="mt-2 mb-4 text-gray-600">
                                La modalidad de enseñanza es 
                                @switch($landing->modality)
                                @case(1)
                                    PRESENCIAL donde los estudiantes asisten regularmente a clase y desarrollan su proceso de aprendizaje en un entorno grupal y presencial.                                 
                                    @break
                                @case(2)
                                    EN LÍNEA es una modalidad de estudio que te permite estudiar sin descuidar las actividades diarias, y además representa la mejor opción si buscas especializarte en un campo de estudio, pudiendo así adquirir las habilidades y competencias necesarias para poder incursionar en el ámbito laboral.
                                    @break
                                @endswitch
                            </p>
                        </div>
                ...
                <div class="w-full md:w-4/12 px-4 text-center  wow fadeInUp">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                        <div class="px-4 py-5 flex-auto">
                            <div class="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-blue-400">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="stroke-current"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path></svg>
                            </div>
                            <h6 class="text-xl text-gray-800 font-semibold">MÓDULOS</h6>
                            <p class="mt-2 mb-4 text-gray-600">
                                Los módulos se usan para organizar el contenido del curso por semanas, unidades o diferentes trabajos de estructura organizacional. Cada profesinal tiene su propia forma de llevar su curso de acuerdo a su experiencia y tema.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="pt-6 w-full md:w-4/12 px-4 text-center  wow fadeInUp">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                        <div class="px-4 py-5 flex-auto">
                            ...
                            <h6 class="text-xl text-gray-800 font-semibold">DURACIÓN</h6>
                            <p class="mt-2 mb-4 text-gray-600">
                                @php
                                    $totalModulos = count($landing->module);

                                @endphp
                                El Diplomado comprende {{$totalModulos }} módulos. Ello implica las horas que incluyen el trabajo individual y preparación de tareas así como
                                el tiempo dedicado para elaborar el trabajo final (ensayo, tesina o programa de estudios).
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex flex-wrap items-center mt-16">
                <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
                    <div class="text-gray-600 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-gray-100">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-award stroke-current"><circle cx="12" cy="8" r="7"></circle><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"></polyline></svg>
                    </div>
                    <h3 class="text-3xl mb-2 font-semibold leading-normal text-gray-800">Beneficios</h3>
                    <p class="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700">{!!$landing->benefits !!}</p>
                    <h3 class="text-3xl mb-2 font-semibold leading-normal text-gray-800">Experiencia</h3>
                    <p class="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700">Ponentes de alta calidad académica y con amplia experiencia profesional.</p>
                </div>
                <div class="w-full md:w-4/12 px-4 mr-auto ml-auto">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-red-800"><img alt="..." src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1051&amp;q=80" class="w-full align-middle rounded-t-lg">
                        <blockquote class="relative p-8 mb-4"><svg preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 583 95" class="absolute left-0 w-full block" style="height: 95px; top: -94px;"><polygon points="-30,95 583,95 583,65" class="text-red-800 fill-current"></polygon></svg>
                            <h4 class="text-xl font-bold text-white">La importancia de la formación continua para el profesional</h4>
                            <p class="text-md font-light mt-2 text-white">Los objetivos que nos marquemos serán más fáciles de alcanzar si nos apoyamos en la formación que nos puedan brindar los profesionales y expertos de cada campo. Parafraseando a Newton, caminemos sobre hombros de gigantes.</p>
                        </blockquote>
                    </div>
                </div>
            </div>
    ...
    <!-- Section of accordion modules https://www.tailwindtoolbox.com/components/accordion  -->
    <section class="bg-white text-gray-800  py-8">
        <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">Módulos</h1>
        <div class="w-full mb-4">
            <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
        </div>
        <div class="w-full md:w-3/5 mx-auto p-8">
            <div class="shadow-md">
                @foreach ($landing->module as $key=>$module)
                    <div class="tab w-full overflow-hidden border-t">
                        <input class="absolute opacity-0 " id="{{ $key}}" type="checkbox" name="tabs">
                        <label class="block p-5 leading-normal cursor-pointer  " for="{{ $key}}">{{ $module->name}}</label>
                        <div class="tab-content overflow-hidden bg-gray-100  leading-normal">
                           
                            @foreach ($module->submodule as $submodule)
                            <h3 class="pl-4 text-1xl mb-2 font-semibold leading-normal text-gray-800">{{ $submodule->name}}</h3>
                            
                                <ol class="class="list-decimal"">
                                    @foreach ($submodule->subtheme as $subtheme)
                                        <li>
                                            <h3 class="pl-8 text-base mb-2 font-semibold leading-normal text-gray-800">{{$subtheme->name}}</h3>
                                        </li>
                                    @endforeach
                                </ol>
    ...
    <!-- Section of teachers -->
    <section class="bg-white   py-8">
        <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">Formadores</h1>
        <div class="w-full mb-4">
            <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
        </div>
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap justify-center text-center mb-24">
                <div class="w-full lg:w-6/12 px-4">
                    <p class="text-lg leading-relaxed m-4 text-gray-600  wow fadeInUp">Ofrecemos Programas de excelencia académica. Contamos con más de 10 años de experiencia ofertando cursos y diplomados de alto nivel académico. Nuestros docentes investigadores y catedráticos son especialistas con experiencia práctica
                        de alto nivel. </p>
                </div>
            </div>
            <div class="flex flex-wrap">
                @foreach ($landing->teacher as $item)
                <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4  wow fadeInUp">
                <div class="px-6">
                    @if(strlen($item->photo) > 2)
                        <img alt="{{$item->name}}" src="{{ URL::asset('img/'.$item->photo)}}" class="shadow-lg rounded-full max-w-full mx-auto" style="max-width: 120px;">
                    @else
                        <img alt="{{$item->name}}" src="{{ URL::asset('img/noprofile.svg')}}" class="shadow-lg rounded-full max-w-full mx-auto" style="max-width: 120px;">

                    @endif
                        <div class="pt-6 text-center">
                            
                            <h5 class="text-xl font-bold text-gray-800">{{ $item->academic_title.' '.$item->name }}</h5>
                            ...
                            {{-- <div class="mt-6">
                                ...
                                <button class="bg-blue-400 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1"
                                    ...
                                    <button class="bg-gray-800 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1" type="button"><i class="fab fa-instagram"></i></button></div> --}}
                        </div>
                    </div>
                </div>
                @endforeach
            ...
            <div class="flex justify-center">
                @foreach ($landing->video as $item)
                    @if(strlen($item->url)>5)
                    <div class="text-center px-4 py-20 m-2 ">
                        <div class="videos-thumb">
                            <a class="popup-youtube" href="{{$item->url}}" class="bg-red-400">
                                ...
                                <p class="text-gray-600">Ver Vídeo</p>
                            </a>
                        </div>
                    </div>
                    @endisset
    ...
    <section class="container mx-auto text-center py-6 mb-12 ">
        <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-white  wow fadeInUp">Contacta con nosotros</h1>
        <div class="w-full mb-4">
            <div class="h-1 mx-auto bg-white w-1/6 opacity-25 my-0 py-0 rounded-t"></div>
        </div>

        <h3 class="my-4 text-3xl leading-tight  wow fadeInUp">Haz click en el botón y te atenderemos a la brevedad posible</h3>

    <a href="https://wa.me/{{$landing->whatsapp}}?text={{ urlencode('Solicito información sobre '.$landing->name)}}" class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg">CONTACTAR AHORA</a>
    ...
    <footer class="bg-white">
        <div class="container mx-auto  px-8">
            ...
            <div class="w-full flex flex-col md:flex-row py-6">
                ...
                <div class="flex-1">
                    <p class="uppercase text-gray-500 md:mb-6">Enlances</p>
                ...
                <div class="flex-1">
                    <p class="uppercase text-gray-500 md:mb-6">Nosotros</p>
                    <ul class="list-reset mb-6">
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
